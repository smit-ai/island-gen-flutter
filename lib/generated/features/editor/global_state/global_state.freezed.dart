...
part of 'package:island_gen_flutter/features/editor/global_state/global_state.dart';
...
class _$GlobalStateImpl implements _GlobalState {
  const _$GlobalStateImpl({this.isLoading = false});
...
abstract class _GlobalState implements GlobalState {
  const factory _GlobalState({final bool isLoading}) = _$GlobalStateImpl;
