                        ...
                        Column(
                          children: [
                            _buildDropdown<LayerNoiseType>(
                              ...
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(type: value)),
                            ),
                            const SizedBox(height: 16),
                            _buildSlider(
                              'Scale',
                              ...
                              0.1,
                              10.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(scale: value)),
                            ),
                            _buildSlider(
                              'Frequency',
                            ...
                            _buildIntSlider(
                              ...
                              1,
                              8,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(octaves: value)),
                            ),
                            _buildSlider(
                              'Persistence',
                              ...
                              0.0,
                              1.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(persistence: value)),
                            ),
                            _buildSlider(
                              'Lacunarity',
                              ...
                              1.0,
                              4.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(lacunarity: value)),
                            ),
                          ],
                        ),
                      ),
                        ...
                        Column(
                          children: [
                            _buildSlider(
                              ...
                              -100.0,
                              100.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(offsetX: value)),
                            ),
                            _buildSlider(
                              'Offset Y',
                              layer.noise.offsetY,
                              -100.0,
                              100.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(offsetY: value)),
                            ),
                            _buildSlider(
                              'Rotation',
                              ...
                              0.0,
                              360.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(rotation: value)),
                            ),
                          ],
                        ),
                      ),
                        ...
                        Column(
                          children: [
                            _buildSlider(
                              ...
                              0.0,
                              1.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(clampMin: value)),
                            ),
                            _buildSlider(
                              'Clamp Max',
                              ...
                              0.0,
                              1.0,
                              (value) => controller.updateNoiseParams(layer.noise.copyWith(clampMax: value)),
                            ),
                            CheckboxListTile(
                              title: const Text('Invert'),
                              value: layer.noise.invert,
                              onChanged: (value) => controller.updateNoiseParams(layer.noise.copyWith(invert: value ?? false)),
                            ),
                          ],
                        ),
                      ),
